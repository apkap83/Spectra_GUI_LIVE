...
public class FileSystemStorageService implements StorageService {
	...
	public void store(MultipartFile file) {
		try {
			...
			if (!Pattern.compile(".+\\.xlsx").matcher(file.getOriginalFilename()).find()) {
				logger.error("Error: Tried to upload a non-excel (xlsx) file type");
				throw new ApiRequestException("Error: Tried to upload a non-excel (xlsx) file type");
			}
