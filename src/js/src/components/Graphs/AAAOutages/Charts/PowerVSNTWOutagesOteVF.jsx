...
const apiEndPoint = config.apiPrefix + "/api/charts/getPowerVSNTWOutagesOteVF";
...
const chartAxisData = [
  "Power vs Network Outages - OTE + VF",
  "Percentage %",
  "Percentage %",
];
...
export const PowerVSNTWOutagesOTEVodafoneChart = ({ dateRange }) => {
